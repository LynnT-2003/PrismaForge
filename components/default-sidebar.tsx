      ...
      <SidebarContent className="mx-4">
        <SidebarGroup className="">
          ...
          <SidebarGroupContent className="mt-0">
            <SidebarMenu>
              <SidebarMenuItem
                className="py-5 ml-[-0.4rem] hover:cursor-pointer transition-all duration-150 ease-linear"
                onClick={() => router.push("/")}
              >
                <SidebarMenuButton
                  asChild
                  className="text-lg space-x-1 active:text-gray-700"
                >
                  <a>
              ...
              {/* <Collapsible defaultOpen>
                <CollapsibleTrigger className="py-5 w-full flex items-center text-lg transition-all duration-150 ease-linear">
                  ...
                  <SidebarMenu>
                    <div className="mb-1">
                      ...
                      >
                        ...
                        >
                          <a>
                            <span className="text-base hover ml-7 flex">
